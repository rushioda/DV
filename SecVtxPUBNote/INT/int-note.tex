...
%-------------------------------------------------------------------------------
\documentclass[NOTE, atlasdraft=true, texlive=2018, UKenglish]{\ATLASLATEXPATH atlasdoc}
...
% Add you own definitions here (file int-note-defs.sty).
...
\subfigure[$m(\gluino) = 2~\TeV$, $m(\tilde{\chi}_{1}^{0}) = 100~\GeV$]{ 
  \label{fig:nmatch_eff_exAssist_mc15_13TeV.402735}
  \includegraphics[width=0.61\textwidth]{figures/event_0004.pdf}
}
\subfigure[$m(\gluino) = 2~\TeV$, $m(\tilde{\chi}_{1}^{0}) = 1.9~\TeV$]{ 
  \label{fig:nmatch_eff_exAssist_mc15_13TeV.403087} 
  \includegraphics[width=0.61\textwidth]{figures/event_0092}
}
